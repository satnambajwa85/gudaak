...
<body>
	    ...
	    <div class="wrapper">
                	...
                	<div style="float:left; width:95%; padding-left:3%; font-size:18px; color:#333; margin-top:10%;   font-family:Arial, Helvetica, sans-serif; ">
                    	Gudaak IPC Report
                    </div>
...
<br/>
						...
						<p style="color:#666;font-weight:bold;font-family:Helvetica;">This report contains the following:<br/>
  ...
  <tr>
   ...
   <div style="width:150px;text-align:left; height:20px;margin:0px;padding:10px;background-color:#fff; ">
    Name
    </div>
	 
	 <div style="width:150px;text-align:left; height:20px;margin:0px;padding:10px;background-color:#F5F5F5; ">
     Gender
     </div> 
	  <div style="width:150px;text-align:left; height:20px;margin:0px;padding:10px;background-color:#fff; ">
    Date of birth
 ...
 <div style="float:left; width:100%; min-height:700px; " >
                ...
                <div style="float:left; width:95.50%; height:438px; margin:20% 20%; " >
	                  ...
	                  <?php foreach($reports as $report){?>
						<?php if($report['id']==2){ ?>
						<div style="float:left; width:100%; min-height:700px;margin-top:100px; " >
 ...
 <?php foreach($report['results'] as $result){?>
		     <div style="float:left; color: #999;width:95%; padding-left:3%; font-size:18px;  font-family:Arial, Helvetica, sans-serif; ">
    ...
    <?php 
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="0" style=" font-family:Arial, Helvetica, sans-serif; color:#666; font-size:18px; ">
  <tbody><tr>

    <td width="100%" valign="middle" bgcolor="#1acccc" align="left" height="40" style="border-right:1px solid #e4e4e4;  color:#fff; ">
	<div style="width:750px;text-align:left;">The top three career clusters that suit your IPC profile are :</div>
	</td>
    </tr>
  <tr>
     <td width="55%" valign="middle" align="left" style="border-right:1px solid #e4e4e4; border-bottom:1px solid #e4e4e4;  line-height:22px;"><br>
	...
	<?php
		...
		<?php foreach($streamList as $streamRec){
  ...
  <div style="width:100%;text-align:left;">
	•	<?php echo $streamRec->name;?> 
		<p><?php echo $streamRec->description;?> </p>
</div> 
	<br><br>
