...
class SessionQuestionsController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('SessionQuestions');
	...
	{
		$model=SessionQuestions::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='session-questions-form')
		{
