...
class CounselorHasSchoolsController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('CounselorHasSchools');
	...
	{
		$model=new CounselorHasSchools('search');
	...
	{
		$model=CounselorHasSchools::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='counselor-has-schools-form')
		{
