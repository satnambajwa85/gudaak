...
class ArticlesCommentsController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('ArticlesComments');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['ArticlesComments']))
			$model->attributes=$_GET['ArticlesComments'];
	 ...
	 * @param ArticlesComments $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='articles-comments-form')
		{
