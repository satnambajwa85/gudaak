...
<?php endif; ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownlist($model,'career_options_id',CHtml::listData(CareerOptions::model()->findAllByAttributes(array('id'=>$id)),'id','title'),array('class'=>'form-control')); ?>
