...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'video_link',array('size'=>60,'maxlength'=>300)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'orient_categories_id'); ?>
		<?php echo $form->textField($model,'orient_categories_id'); ?>
	</div>
