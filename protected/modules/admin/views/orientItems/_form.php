...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<?php echo $form->dropDownlist($model,'orient_categories_id',CHtml::listData(OrientCategories::model()->findAll(),'id','title'),array('class'=>'form-control')); ?>
	...
	<div class="form-group">
		...
		<img width="100" height="100" src="<?php echo Yii::app()->request->baseUrl.'/uploads/orient_items/small/'.$model->image;?>" alt="image"/>
		<?php }?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'video_link'); ?>
		<?php echo $form->textField($model,'video_link',array('size'=>60,'maxlength'=>300,'class'=>'form-control')); ?>
