<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('score_start')); ?>:</b>
	<?php echo CHtml::encode($data->score_start); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('score_end')); ?>:</b>
	<?php echo CHtml::encode($data->score_end); ?>
	<br />
