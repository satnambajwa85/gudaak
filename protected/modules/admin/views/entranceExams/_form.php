...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<select name="career_category[]" multiple="multiple">
        <?php $lists	=	EntranceCategory::model()->findAll();
		foreach($lists as $lis){?>
			<option value="<?php echo $lis->id;?>" <?php echo (in_array($lis->id,$selec))?'selected="selected"':'';?> ><?php echo $lis->title;?></option>
		<?php }?>		
        </select>
		<?php //echo $form->dropDownlist('EntranceExams[career_category]',$selec,CHtml::listData(EntranceCategory::model()->findAll(),'id','title'),array('empty'=>'Please Select','class'=>'form-control','multiple'=>'multiple'));?>
