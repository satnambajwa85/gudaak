...
$this->breadcrumbs=array('Careers Categories'=>array('/admin/careerCategories/admin'),'Careers'=>array('adminView','id'=>$_REQUEST['id']),'Create',);
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'career_categories_id');
			echo $form->dropDownlist($model,'career_categories_id',CHtml::listData(CareerCategories::model()->findAllByAttributes(array('id'=>$id)),'id','title'),array('class'=>'form-control')); ?>
