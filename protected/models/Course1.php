...
/**
 * This is the model class for table "course1".
 *
 * The followings are the available columns in table 'course1':
 * @property integer $id
 ...
 */
class Course1 extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Course1 the static model class
	 */
