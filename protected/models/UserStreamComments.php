...
/**
 * This is the model class for table "user_stream_comments".
 *
 * The followings are the available columns in table 'user_stream_comments':
 * @property integer $id
 ...
 */
class UserStreamComments extends CActiveRecord
{
	/**
	 ...
	 * @return UserStreamComments the static model class
	 */
