 ...
 * @property string $career_category
...
class EntranceExams extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, level, career_category, details, status', 'required'),
			array('status', 'numerical', 'integerOnly'=>true),
			array('name, level', 'length', 'max'=>500),
			array('career_category', 'length', 'max'=>100),
			array('start_date, end_date, test_date, result_date, add_date', 'safe'),
	...
	public function search()
	{
		...
		$criteria->compare('career_category',$this->career_category,true);
