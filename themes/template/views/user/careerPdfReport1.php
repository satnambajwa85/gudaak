...
<body>
   <table width="750px" border="0" cellspacing="0" cellpadding="0" style=" font-family:Arial, Helvetica, sans-serif; color:#000; font-size:18px; ">
	<tr>
		<td>
			<div style="float:left;margin-left:30px; width:620px; margin-top:17px; margin-bottom:50px; background:#1acccc; height:39px; padding-top:14px; text-align:right; font-size:18px; color:#fff; padding-right:70px; font-family:Arial, Helvetica, sans-serif;">
			Profile Summary&nbsp;
				<div style=" position:absolute; width:200px; height:139px; top:1px; left:15%;">
	...
	<table width="650" border="0" cellspacing="0" cellpadding="0" style=" margin-left:30px; font-family:Arial, Helvetica, sans-serif; color:#000; font-size:18px; ">
	<tr>
    <td colspan="2">
  ...
  <tr>
    <td width="220" align="left" valign="left" style="border-left:1px solid #fff;font-size:12px; background-color:#F5F5F5; border-top:1px solid #fff; border-bottom:1px solid #fff; ">
   <div style="width:220px;text-align:left; height:20px;margin:0px;padding:10px;background-color:#fff; ">
    Name
    </div>
	 <div style="width:220px;text-align:left; height:20px;margin:0px;padding:10px;background-color:#F5F5F5; ">
     Class
     </div> 
	  <div style="width:220px;text-align:left; height:20px;margin:0px;padding:10px;background-color:#fff; ">
   School
    ...
    <td width="400" align="left" valign="left" style="font-size:12px; background-color:#F5F5F5;border-right:1px solid #fff; border-bottom:1px solid #fff; border-top:1px solid #fff;"> 
	<div style="width:420px;text-align:left; height:20px;margin:0px;padding:10px;background-color:#fff; ">
	<?php echo $profile->first_name.' '.$profile->last_name;?>
   </div> 
   <div style="width:420px;text-align:left; height:20px;margin:0px;padding:10px;background-color:#F5F5F5; ">
  ...
  <table border="0" width="650" cellspacing="0" cellpadding="0" style="margin-left:50px; font-family:Arial, Helvetica, sans-serif; ">
	<tr>
    ...
    <tr>
    <td style="font-size:11px; text-align:right; width:460px; color:#fff; background:#1acccc; height:25px; padding-top:5px; padding-right:5px; "> Note: This Report is confidential and is only indicative of preferred careers for you.</td>
    </tr>
  </table>
   <table width="670" border="0" cellspacing="0" cellpadding="0" style=" margin-left:30px; font-family:Arial, Helvetica, sans-serif; color:#000; font-size:18px; ">
	<tr>
		<td><div style="float:left; width:100%; margin-top:17px; margin-bottom:50px; background:#1acccc; height:39px; padding-top:14px; text-align:right; font-size:18px; color:#fff; padding-right:10%; font-family:Arial, Helvetica, sans-serif;">
			&nbsp;
				<div style=" position:absolute; width:200px; height:139px; top:1px; left:15%;">
					<img alt="" src="./image/small.jpg">
				</div>                    
                	...
                	<div style="float:left; width:97%; font-size:14px; color:#000; text-align:justify; line-height:22px; font-family:, Helvetica, sans-serif;  ">
...
<br/>
    ...
    <tr>
    <td style="font-size:11px;  text-align:right; width:600px; color:#fff; background:#1acccc; height:22px; padding-top:5px; padding-right:3px; "> Note: This Report is confidential and is only indicative of preferred careers for you.</td>
    </tr>
	</table>
	                <?php 
					...
					foreach($reports as $report){
						$listArr[]	=	$report[$report['id']]['descr'];
						if($report['id']==2){
							
							?>
						<div style="float:left; width:650px;" >
						<div style="float:left; width:100%;margin-left:30px; margin-top:17px; margin-bottom:50px; background:#1acccc; height:39px; padding-top:14px; text-align:right; font-size:18px; color:#fff; padding-right:10%; font-family:Arial, Helvetica, sans-serif;">
			Personality Test Summary&nbsp; 
				<div style=" position:absolute; width:200px; height:139px; top:0px; left:15%;">
					<img alt="" src="./image/small.jpg">
				</div>                    
			</div>
						
                        <div style="float:left;width:95%;margin-left:30px;font-size:18px;color:#21C4C1;margin-top:10%;font-family:Arial, Helvetica, sans-serif; ">
								Your Personality Mapping
							</div>
							<div style="float:left; width:95%; margin-left:30px; font-size:14px; color:#000; text-align:justify; line-height:20px; font-family:, Helvetica, sans-serif;  ">
...
<table width="450">
    ...
    <tr>
    <td style="font-size:11px;  text-align:right; width:400px; color:#fff; background:#1acccc; height:22px; padding-top:5px; padding-right:3px; "> Note: This Report is confidential and is only indicative of preferred careers for you.</td>
    </tr>
    <tr>
    <td>
...
<?php	//$counter	=	abs($counter-1);
    ...
    <?php if($report['id']==2){?>
    <tr>
    <td style="font-size:11px;  text-align:right; width:750px; color:#fff; background:#1acccc; height:22px; padding-top:5px; padding-right:3px; "> Note: This Report is confidential and is only indicative of preferred careers for you.</td>
    </tr>
    <?php } ?>
    </table>
              ...
              <div style="float:left; width:100%; margin:8px 0 0 0;">
				   <table width="800px" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							 <div style="float:left; width:600px; height:100px; background:#1acccc; padding-right:8px; text-align:center; vertical-align:middle;  ">
								<div style="float:right; width:50%;text-align:center; margin-right:2%; color:#fff; font-size:17px; line-height:22px; font-family:Arial, Helvetica, sans-serif; margin-top:7px;">
								Call: +91 8786 76545,  <br />
								Email: info@gudaak.com <br />
                                Website: www.gudaak.com 
								</div>
