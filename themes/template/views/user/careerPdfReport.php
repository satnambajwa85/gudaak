...
<body>
  ...
  <table border="0" width="650" cellspacing="0" cellpadding="0" style="margin-left:50px; font-family:Arial, Helvetica, sans-serif; ">
   ...
   <table width="650" border="0" cellspacing="0" cellpadding="0" style=" margin-left:50px; font-family:Arial, Helvetica, sans-serif; color:#000; font-size:18px; ">
	<tr>
			...
			Personality Test Summary&nbsp; 
				<div style=" position:absolute; width:200px; height:139px; top:0px; left:15%;">
					<img alt="" src="./image/small.jpg">
                        ...
                        <tr>
		<td>
         <div style="float:left; width:650px; margin-top:17px; margin-bottom:50px; background:#1acccc; height:39px; padding-top:14px; text-align:right; font-size:18px; color:#fff; padding-right:10%; font-family:Arial, Helvetica, sans-serif;">
...
<table width="650">
    ...
    <tr>
    <td style="font-size:11px;  text-align:right; width:650px; color:#fff; background:#1acccc; height:22px; padding-top:5px; padding-right:3px; "> Note: This Report is confidential and is only indicative of preferred careers for you.</td>
    </tr>
    <tr>
    <td>
