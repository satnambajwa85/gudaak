...
Based on your personality and interest you can explore the right type of role in the careers <br />that are characterized by the following features:
	...
	if($report['id']==3){
		...
		<td width="210" height="90">
			<div style="color: #000000;font-size: 12px;width:200px;float:left !important;text-align:left;">
				<img src="./uploads/stream/small/<?php echo $streamRec->image;?>" style="width:200px;"/>
			</div>
            <div style="color: #000000;font-size: 12px;width:200px;height:30px;float:left !important;text-align:left;">
