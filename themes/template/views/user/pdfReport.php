...
<body>
  ...
  <table border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; ">
	<tr>
   ...
   <table width="800px" border="0" cellspacing="0" cellpadding="0" style=" font-family:Arial, Helvetica, sans-serif; color:#000; font-size:18px; ">
	<tr>
...
<?php	//$counter	=	abs($counter-1);
	...
	if($report['id']==3){
		...
		<td width="200px">
			<div style="color: #000000;font-size: 12px;width:30%;float:left !important;text-align:left;">
				<img src="./uploads/stream/small/<?php echo $streamRec->image;?>" style="width:250px;float:left"/>
			</div>
            <div style="color: #000000;font-size: 12px;width:240px;height:30px;padding-top:20px;text-align:left;">
				<span><?php echo $streamRec->name;?></span><br/>
