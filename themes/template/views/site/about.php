...
<div class="home-tabing about-fix container  ">
	<div class="row">
		<div class="col-md-12 pull-left mt50">
			...
			<div class="col-md-6 pull-left right-tab-content padding-left">
					<a href="#"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/laptop_mask.png"/></a>
				<h3>Just sign up and start having test for your interest!</h3>
				<p>
						Windows, OS X and Linux have their own style for the scroll bar as you can see in the following screenshot. This in return could lead to undesired results and consistencies for your design. 
						Windows, OS X and Linux
				</p>
				
				<button  class="btn btn-warning home-login-box2" type="button">Join Today!</button>
			</div>
		</div>
	</div>	
