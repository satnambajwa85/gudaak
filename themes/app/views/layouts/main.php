		 ...
		 <div class="container">
			 <div class="hot-link-icon">
				<ul>
					...
					<li><?php echo CHtml::link('<i class="glyphicon glyphicon-globe"></i>',array(''),array('data-toggle'=>'tooltip','data-placement'=>'bottom','title'=>'Global'));?></li>
					<li><?php echo CHtml::link('<i class="glyphicon glyphicon-glass"></i>',array(''),array('data-toggle'=>'tooltip','data-placement'=>'bottom','title'=>'Win'));?></li>
	...
	<div class="modal-dialog">
		...
		<!-- dialog body -->
			...
			<div class="col-md-12 pd13" id="render">
				<div  class="col-md-6 login-box pull-left">
					<div id="">
						...
						<h4 class="form-signin-heading pd4">Login your profile</h4>
			...
			<?php 
				...
				<h4 class="form-signin-heading pd4">Enroll your future!!!</h4>
