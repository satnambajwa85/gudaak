...
<div id="no-more-tables" class="table-responsive iphone_table">
	<table class="table">
		<thead>
			<tr class="text-center">
				...
				<td width="" class="text-center">                                                    
					<h5 class="semibold mt5 mb5 text-tealmedium text-center">Enterprise Grade</h5>
					<small class="text-muted">
						<ul class="text-center np">
							<li class="">Clientele: Fortune 1000</li>
							<li class="">5 years in business</li>
							<li class="">Experience in scalability &amp; high compliance domains</li>
						</ul>
					</small>
				</td>
				<td width="" class="text-center">                
					...
					<small class="text-muted">
						<ul class="text-center np">
							<li class="">Clientele: Mid-market companies &amp; funded startups</li>
							<li class="">3 years in business</li> 
							<li class="">Exposure to scalability &amp; high compliance domains</li>
						</ul>
					</small>
				</td>
				<td width="" class="text-center">                
				...
				<small class="text-muted">
					<ul class="text-center np">
						<li class="">Clientele: Startups</li>
						<li class="">1 years in business</li>
						<li class="">Basic knowledge about compliance and security</li>
					</ul>
				</small>
				</td>
			</tr>
