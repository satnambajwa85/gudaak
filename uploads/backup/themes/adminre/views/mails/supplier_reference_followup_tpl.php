...
<div class="grey">
	...
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
			I just wanted to follow up on my earlier email. I am Sam from VenturePact, an invite only marketplace that connects companies with top tier software development firms. <?php echo $data["first_name"]." ".$data["last_name"] ?> mentioned that they have worked with you in the past.
			<br/><br/>
			We, at VenturePact, believe customer feedback is crucial as it helps service providers improve and allows clients to make better decisions. We were wondering if you can take a minute to review & rate your experience with <?php echo $data["first_name"]." ".$data["last_name"] ?>for our platform.
			<br/><br/>
			            
            Click the link below to recommend.
			<br /><br /><br />			
