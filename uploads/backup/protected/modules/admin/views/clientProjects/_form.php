    ...
    <div class="row">
		...
		foreach(ClientProfiles::model()->findAll() as $clientInfo)
		{
			...
			?>
                         ...
                         {
                            echo CHtml::dropDownList('Client_id',$project->client_profiles_id,$clientNew,array('class'=>'form-control required ','empty'=>'Select A Client'));   
                         } else{
                            echo CHtml::dropDownList('Client_id',$project->client_profiles_id,$clientNew,array('class'=>'form-control required ','empty'=>'Select A Client','disabled'=>'disabled'));
                         }
