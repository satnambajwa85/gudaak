...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'suppliers_id'); ?>
	 	<?php
				$lists	    =	Suppliers::model()->findAll('status=2');
				$listData = CHtml::listData($lists,'id', 'name');
				if(!$model->isNewRecord)
			     echo $form->textField($model->suppliers,'name',array('size'=>60,'maxlength'=>250,'disabled'=>'disabled'));
			   else
	...
	<div class="row">
        ...
        <div class=" btn file btn-info small" id="openBrow" style="padding: 4px 10px;margin-bottom: 5px;">
	 	<span class="icon iconmoon-file-3"></span>Browse</div>
