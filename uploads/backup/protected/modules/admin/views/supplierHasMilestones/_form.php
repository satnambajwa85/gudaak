...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'supplier_project_proposal_id'); ?>
		<?php echo $form->textField($model,'supplier_project_proposal_id'); ?>
		<?php echo $form->error($model,'supplier_project_proposal_id'); ?>
	</div>
