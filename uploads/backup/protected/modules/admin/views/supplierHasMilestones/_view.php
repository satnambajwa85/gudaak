...
/* @var $data SupplierHasMilestones */
?>
...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('supplier_project_proposal_id')); ?>:</b>
	<?php echo CHtml::encode($data->supplier_project_proposal_id); ?>
	<br />
