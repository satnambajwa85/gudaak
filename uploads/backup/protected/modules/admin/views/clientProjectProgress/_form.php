...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'client-project-progress-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'detials'); ?>
		<?php echo $form->textArea($model,'detials',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'detials'); ?>
	</div>
