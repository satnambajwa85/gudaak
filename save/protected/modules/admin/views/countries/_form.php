...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<img width="100" height="100" src="<?php echo Yii::app()->request->baseUrl.'/uploads/countries/small/'.$model->image;?>" alt="image"/>
		<?php }?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'code_1'); ?>
		<?php echo $form->textField($model,'code_1',array('size'=>45,'maxlength'=>45,'class'=>'form-control')); ?>
		<?php echo $form->error($model,'code_1'); ?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'code_2'); ?>
		<?php echo $form->textField($model,'code_2',array('size'=>45,'maxlength'=>45,'class'=>'form-control')); ?>
