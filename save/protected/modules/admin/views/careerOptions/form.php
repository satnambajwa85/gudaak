...
$this->breadcrumbs=array('Careers Categories'=>array('/admin/careerCategories/admin'),'Careers'=>array('/admin/career/adminView'),'Careers Options'=>array('/admin/careerOptions/adminView','id'=>$id),);
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<?php echo $form->dropDownlist($model,'career_id',CHtml::listData(Career::model()->findAllByAttributes(array('id'=>$id)),'id','title'),array('class'=>'form-control')); ?>
