...
<?php $action	=	Yii::app()->controller->action->id;
	...
	if($action=='schools'||$action=='students'||$action=='WhyGudaak'||$action=='WhatIsGudaak'||$action=='error'){
		$css	=	'erternalPages';
	}
				...
				<div id="header_cont">
					<div class="header">
                  	...
                  	<ul class="right_nav">
						...
						<li><?php echo CHtml::link('Schools',array('site/schools'),array('class'=>''.(Yii::app()->controller->action->id=='schools')?'white-text':''.''));?></li>
